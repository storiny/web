...
worker.use(
  rest.get(
    `${process.env.NEXT_PUBLIC_API_URL}/v1/me/blogs/:blog_id/editor-requests`,
    (req, res, ctx) =>
      res(
        ctx.delay(750),
        ctx.json(
...
worker.use(
  rest.post(
    `${process.env.NEXT_PUBLIC_API_URL}/v1/me/blogs/:blog_id/editor-requests/:request_id/cancel`,
