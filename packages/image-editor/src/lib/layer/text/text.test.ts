...
import { ExcalidrawTextLayerWithContainer, FontString } from "./types";
...
describe("Test measureText", () => {
  describe("Test getContainerCoords", () => {
    ...
    it("should compute coords correctly when ellipse", () => {
      ...
      expect(getContainerCoords(layer)).toEqual({
  ...
  describe("Test computeContainerDimensionForBoundText", () => {
    ...
    it("should compute container height correctly for rectangle", () => {
      ...
      expect(computeContainerDimensionForBoundText(150, layer.type)).toEqual(
        160
      );
    });
  ...
  describe("Test getBoundTextMaxWidth", () => {
    ...
    it("should return max width when container is rectangle", () => {
      const container = API.createLayer({ type: "rectangle", ...params });
      expect(getBoundTextMaxWidth(container)).toBe(168);
    });

    it("should return max width when container is ellipse", () => {
      const container = API.createLayer({ type: "ellipse", ...params });
      expect(getBoundTextMaxWidth(container)).toBe(116);
    });

    it("should return max width when container is diamond", () => {
      const container = API.createLayer({ type: "diamond", ...params });
  ...
  describe("Test getBoundTextMaxHeight", () => {
    ...
    const boundTextLayer = API.createLayer({
      type: "text",
      id: "text-id",
      x: 560.51171875,
      y: 202.033203125,
    ...
    it("should return max height when container is rectangle", () => {
      const container = API.createLayer({ type: "rectangle", ...params });
      expect(getBoundTextMaxHeight(container, boundTextLayer)).toBe(184);
    });

    it("should return max height when container is ellipse", () => {
      const container = API.createLayer({ type: "ellipse", ...params });
      expect(getBoundTextMaxHeight(container, boundTextLayer)).toBe(127);
    });

    it("should return max height when container is diamond", () => {
      const container = API.createLayer({ type: "diamond", ...params });
      expect(getBoundTextMaxHeight(container, boundTextLayer)).toBe(87);
    });
    ...
    it("should return max height when container is arrow", () => {
      ...
      expect(getBoundTextMaxHeight(container, boundTextLayer)).toBe(194);
    });
    ...
    it("should return max height when container is arrow and height is less than threshold", () => {
      ...
      expect(getBoundTextMaxHeight(container, boundTextLayer)).toBe(
...
describe("Test detectLineHeight", () => {
  it("should return correct line height", () => {
    expect(detectLineHeight(textLayer)).toBe(1.25);
  });
});

describe("Test getLineHeightInPx", () => {
  it("should return correct line height", () => {
    expect(getLineHeightInPx(textLayer.fontSize, textLayer.lineHeight)).toBe(
      25
    );
  });
});
