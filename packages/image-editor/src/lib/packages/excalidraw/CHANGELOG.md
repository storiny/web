...
- Properly sanitize layer `link` urls. [#6728](https://github.com/excalidraw/excalidraw/pull/6728).
...
- Rotate the text layer when binding to a rotated container [#6477](https://github.com/excalidraw/excalidraw/pull/6477)
...
- [`restoreLayers`](https://docs.excalidraw.com/docs/@excalidraw/excalidraw/api/utils/restore#restorelayers) API now takes an optional parameter `opts` which currently supports the below attributes
...
- The optional parameter `refreshDimensions` in [`restoreLayers`](https://docs.excalidraw.com/docs/@excalidraw/excalidraw/api/utils/restore#restorelayers) has been removed and can be enabled via `opts`
...
- Add container to multiple text layers [#6428](https://github.com/excalidraw/excalidraw/pull/6428)

- Starting migration from GA to Matomo for better privacy [#6398](https://github.com/excalidraw/excalidraw/pull/6398)

- Add line height attribute to text layer [#6360](https://github.com/excalidraw/excalidraw/pull/6360)
...
- Make repair and refreshDimensions configurable in restoreLayers [#6238](https://github.com/excalidraw/excalidraw/pull/6238)
...
- Disable canvas smoothing (antialiasing) for right-angled layers [#6186](https://github.com/excalidraw/excalidraw/pull/6186)Co-authored-by: Ignacio Cuadra <67276174+ignacio-cuadra@users.noreply.github.com>
...
- Mark more props as optional for layer [#6448](https://github.com/excalidraw/excalidraw/pull/6448)
...
- Don't refresh dimensions for deleted text layers [#6438](https://github.com/excalidraw/excalidraw/pull/6438)

- Layer vanishes when zoomed in [#6417](https://github.com/excalidraw/excalidraw/pull/6417)
...
- Refresh dimensions when layers loaded from shareable link and blob [#6333](https://github.com/excalidraw/excalidraw/pull/6333)
...
- Compute bounding box correctly for text layer when multiple layer resizing [#6307](https://github.com/excalidraw/excalidraw/pull/6307)

- Use jotai scope for editor-specific atoms [#6308](https://github.com/excalidraw/excalidraw/pull/6308)

- Consider arrow for bound text layer [#6297](https://github.com/excalidraw/excalidraw/pull/6297)

- Text never goes beyond max width for unbound text layers [#6288](https://github.com/excalidraw/excalidraw/pull/6288)
...
- Sort bound text layers to fix text duplication z-index error [#5130](https://github.com/excalidraw/excalidraw/pull/5130)
...
- Merged `appState.currentItemStrokeSharpness` and `appState.currentItemLinearStrokeSharpness` into `appState.currentItemRoundness`. Renamed `changeSharpness` action to `changeRoundness`. Excalidraw layer's `strokeSharpness` was changed to `roundness`. Check the PR for types and more details [#5553](https://github.com/excalidraw/excalidraw/pull/5553).
...
- Not properly restoring layer stroke and bg colors [#6002](https://github.com/excalidraw/excalidraw/pull/6002)
...
- `ExcalidrawArrowLayer` rather than `ExcalidrawArrowEleement` [#5955](https://github.com/excalidraw/excalidraw/pull/5955)

- RenderFooter styling [#5962](https://github.com/excalidraw/excalidraw/pull/5962)

- Repair layer bindings on restore [#5956](https://github.com/excalidraw/excalidraw/pull/5956)
...
- Dedupe boundLayer ids when container duplicated with alt+drag [#5938](https://github.com/excalidraw/excalidraw/pull/5938)
...
- Stop font `loadingdone` loop when rendering layer SVGs [#5883](https://github.com/excalidraw/excalidraw/pull/5883)
...
- SVG layer attributes in icons.tsx [#5871](https://github.com/excalidraw/excalidraw/pull/5871)
...
- Paste clipboard contents into unbound text layers [#5849](https://github.com/excalidraw/excalidraw/pull/5849)
...
- Line editor points rendering below layers [#5781](https://github.com/excalidraw/excalidraw/pull/5781)

- Syncing 1-point lines to remote clients [#5677](https://github.com/excalidraw/excalidraw/pull/5677)

- Incorrectly selecting linear layers on creation while tool-locked [#5785](https://github.com/excalidraw/excalidraw/pull/5785)
...
- Multiple layers resizing regressions [#5586](https://github.com/excalidraw/excalidraw/pull/5586)
...
- `restoreLayers()` now takes an optional parameter to indicate whether we should also recalculate text layer dimensions. Defaults to `true`, but since this is a potentially costly operation, you may want to disable it if you restore layers in tight loops, such as during collaboration [#5432](https://github.com/excalidraw/excalidraw/pull/5432).
...
- Added support for storing [`customData`](https://github.com/excalidraw/excalidraw/blob/master/src/packages/excalidraw/README.md#storing-custom-data-on-excalidraw-layers) on Excalidraw layers [#5592].
...
- Introduce ExcalidrawLayers and ExcalidrawAppState provider [#5463](https://github.com/excalidraw/excalidraw/pull/5463)

- Enable midpoint inside linear layer editor [#5564](https://github.com/excalidraw/excalidraw/pull/5564)

- Show a mid point for linear layers [#5534](https://github.com/excalidraw/excalidraw/pull/5534)

- Lock angle when editing linear layers with shift pressed [#5527](https://github.com/excalidraw/excalidraw/pull/5527)

- Redesign linear layers 🎉 [#5501](https://github.com/excalidraw/excalidraw/pull/5501)

- Cursor alignment when creating linear layers with shift pressed [#5518](https://github.com/excalidraw/excalidraw/pull/5518)

- Shift-clamp when creating multi-point lines/arrows [#5500](https://github.com/excalidraw/excalidraw/pull/5500)

- Cursor alignment when creating generic layers [#5516](https://github.com/excalidraw/excalidraw/pull/5516)
...
- RestoreLayerWithProperties drops "parent" property [#5742](https://github.com/excalidraw/excalidraw/pull/5742)
...
- Add random tiny offsets to avoid linear layers from being clipped [#5615](https://github.com/excalidraw/excalidraw/pull/5615)
...
- Remove unnecessary conditions in pointerup for linear layers [#5575](https://github.com/excalidraw/excalidraw/pull/5575)
...
- Deselect linear layer when clicked inside bounding box outside editor [#5579](https://github.com/excalidraw/excalidraw/pull/5579)

- Resize multiple layers from center [#5560](https://github.com/excalidraw/excalidraw/pull/5560)

- Call static methods via class instead of instance in linearLayerEditor [#5561](https://github.com/excalidraw/excalidraw/pull/5561)

- Show bounding box for 3 or more linear point layers [#5554](https://github.com/excalidraw/excalidraw/pull/5554)

- Cleanup the condition for dragging layers [#5555](https://github.com/excalidraw/excalidraw/pull/5555)
...
- Flip linear layers after redesign [#5538](https://github.com/excalidraw/excalidraw/pull/5538)
...
- Incorrectly rendering freedraw layers [#5481](https://github.com/excalidraw/excalidraw/pull/5481)
...
- Remove unused attribute hasHitLayerInside from pointerDownState [#5591](https://github.com/excalidraw/excalidraw/pull/5591)
...
- Remove unnecessary if condition for linear layer onKeyDown [#5486](https://github.com/excalidraw/excalidraw/pull/5486)
...
- Prevent selecting `.visually-hidden` layers [#3501](https://github.com/excalidraw/excalidraw/pull/3501).
...
- [`scrollToContent`](https://github.com/excalidraw/excalidraw/blob/master/src/components/App.tsx#L265) API now supports passing just a single Excalidraw layer, or none at all (which will default to current layers on the scene) [#3482](https://github.com/excalidraw/excalidraw/pull/3482).
...
- Changing z-index of layers (sorting them below/above other layers) now updates their `version` and `versionNonce` (only applies to the selected layers). This fix will allow you account for z-index changes if you're syncing just the layers that changed (and not the whole scene) [#3483](https://github.com/excalidraw/excalidraw/pull/3483).
...
- #### BREAKING CHANGE
  ...
  - Removed exposing `getSyncableLayers` helper which was specific to excalidraw app collab implementation [#3471](https://github.com/excalidraw/excalidraw/pull/3471). If you happened to use it, you can easily reimplement it yourself using the newly exposed [isInvisiblySmallLayer](https://github.com/excalidraw/excalidraw/blob/master/src/packages/excalidraw/README.md#isInvisiblySmallLayer) helper:

    ```ts
    const getSyncableLayers = (layers: readonly ExcalidrawLayer[]) =>
      layers.filter((el) => el.isDeleted || !isInvisiblySmallLayer(el));
    ```
...
- Focus on last active layer when dialog closes [#3447](https://github.com/excalidraw/excalidraw/pull/3447).
...
- Support image layers [#3424](https://github.com/excalidraw/excalidraw/pull/3424).
...
- Add option to flip single layer on the context menu [#2520](https://github.com/excalidraw/excalidraw/pull/2520).
...
- Positions stats for linear layers [#3331](https://github.com/excalidraw/excalidraw/pull/3331).
...
- Bail on noop updates for newLayerWith [#3279](https://github.com/excalidraw/excalidraw/pull/3279).
...
- Allow copy of excalidraw layers only when inside excalidraw [#3206](https://github.com/excalidraw/excalidraw/pull/3206).
...
- Add support for `scrollToCenter` in [initialData](https://github.com/excalidraw/excalidraw/blob/master/src/layer/types.ts#L18) so host can control whether to scroll to center on mount [#3070](https://github.com/excalidraw/excalidraw/pull/3070).

- Export [`restore`](https://github.com/excalidraw/excalidraw/blob/master/src/data/restore.ts#L182), [`restoreAppState`](https://github.com/excalidraw/excalidraw/blob/master/src/data/restore.ts#L144) and [`restoreLayers`](https://github.com/excalidraw/excalidraw/blob/master/src/data/restore.ts#L128) to host [#3049](https://github.com/excalidraw/excalidraw/pull/3049)
...
- Fix layer visibility and zoom on cursor when canvas offset isn't 0. [#2534](https://github.com/excalidraw/excalidraw/pull/2534)
...
- Document some of the more exotic layer props [#2673](https://github.com/excalidraw/excalidraw/pull/2673)
