...
import { actionWrapTextInContainer } from "../../core/actions/actionBoundText";
import {
  actionToggleHandTool,
  zoomToFit
} from "../../core/actions/actionCanvas";
import { actionPaste } from "../../core/actions/actionClipboard";
import {
  actionRemoveAllLayersFromFrame,
  actionSelectAllLayersInFrame
} from "../../core/actions/actionFrame";
import {
  createRedoAction,
  createUndoAction
} from "../../core/actions/actionHistory";
import { actionToggleViewMode } from "../../core/actions/actionToggleViewMode";
import { ActionManager } from "../../core/actions/manager";
import { actions } from "../../core/actions/register";
...
import { parseClipboard } from "../../lib/clipboard/clipboard";
import {
  dataURLToFile,
  generateIdFromFile,
  getDataURL,
