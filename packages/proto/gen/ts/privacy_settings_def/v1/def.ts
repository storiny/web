...
export const GetPrivacySettingsResponse = {
  ...
  fromJSON(object: any): GetPrivacySettingsResponse {
    return {
      is_private_account: isSet(object.is_private_account) ? Boolean(object.is_private_account) : false,
      record_read_history: isSet(object.record_read_history) ? Boolean(object.record_read_history) : false,
      allow_sensitive_media: isSet(object.allow_sensitive_media) ? Boolean(object.allow_sensitive_media) : false,
