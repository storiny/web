...
export const protobufPackage = "credentials_def.v1";
...
export const GetCredentialsRequest = {
  encode(message: GetCredentialsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetCredentialsRequest {
  ...
  fromJSON(object: any): GetCredentialsRequest {
    return { id: isSet(object.id) ? String(object.id) : "" };
  },

  toJSON(message: GetCredentialsRequest): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
  ...
  create<I extends Exact<DeepPartial<GetCredentialsRequest>, I>>(base?: I): GetCredentialsRequest {
    return GetCredentialsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetCredentialsRequest>, I>>(object: I): GetCredentialsRequest {
    const message = createBaseGetCredentialsRequest();
...
export const GetCredentialsResponse = {
  encode(message: GetCredentialsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetCredentialsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
