...
export const GetStoryRequest = {
  ...
  fromJSON(object: any): GetStoryRequest {
    return {
      id_or_slug: isSet(object.id_or_slug) ? String(object.id_or_slug) : "",
...
export const GetStoryResponse = {
  ...
  fromJSON(object: any): GetStoryResponse {
    return {
      ...
      splash_id: isSet(object.splash_id) ? String(object.splash_id) : undefined,
      splash_hex: isSet(object.splash_hex) ? String(object.splash_hex) : undefined,
      doc_key: isSet(object.doc_key) ? String(object.doc_key) : "",
      ...
      canonical_url: isSet(object.canonical_url) ? String(object.canonical_url) : undefined,
      seo_description: isSet(object.seo_description) ? String(object.seo_description) : undefined,
      seo_title: isSet(object.seo_title) ? String(object.seo_title) : undefined,
      preview_image: isSet(object.preview_image) ? String(object.preview_image) : undefined,
      created_at: isSet(object.created_at) ? String(object.created_at) : "",
      edited_at: isSet(object.edited_at) ? String(object.edited_at) : undefined,
      published_at: isSet(object.published_at) ? String(object.published_at) : undefined,
      ...
      is_liked: isSet(object.is_liked) ? Boolean(object.is_liked) : false,
      disable_comments: isSet(object.disable_comments) ? Boolean(object.disable_comments) : false,
      disable_public_revision_history: isSet(object.disable_public_revision_history)
        ? Boolean(object.disable_public_revision_history)
        : false,
      disable_toc: isSet(object.disable_toc) ? Boolean(object.disable_toc) : false,
