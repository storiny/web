...
export const GetNotificationSettingsResponse = {
  ...
  fromJSON(object: any): GetNotificationSettingsResponse {
    return {
      features_and_updates: isSet(object.features_and_updates) ? Boolean(object.features_and_updates) : false,
      stories: isSet(object.stories) ? Boolean(object.stories) : false,
      tags: isSet(object.tags) ? Boolean(object.tags) : false,
      comments: isSet(object.comments) ? Boolean(object.comments) : false,
      replies: isSet(object.replies) ? Boolean(object.replies) : false,
      new_followers: isSet(object.new_followers) ? Boolean(object.new_followers) : false,
      friend_requests: isSet(object.friend_requests) ? Boolean(object.friend_requests) : false,
      mail_login_activity: isSet(object.mail_login_activity) ? Boolean(object.mail_login_activity) : false,
      mail_features_and_updates: isSet(object.mail_features_and_updates)
        ? Boolean(object.mail_features_and_updates)
        : false,
      mail_newsletters: isSet(object.mail_newsletters) ? Boolean(object.mail_newsletters) : false,
      mail_digest: isSet(object.mail_digest) ? Boolean(object.mail_digest) : false,
    };
  },
