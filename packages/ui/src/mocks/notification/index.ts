...
export const MOCK_NOTIFICATIONS: Notification[] = [
  {
    ...
    actor: MOCK_USERS[0],
    rendered_content: `<a data-user data-fw-bold href="/${MOCK_USERS[0].username}">${MOCK_USERS[0].name}</a> liked your story "<a data-fw-medium href="/${MOCK_STORIES[0].user?.username}/${MOCK_STORIES[0].slug}">${MOCK_STORIES[0].title}</a>"`,
    created_at: "2022-05-18T01:07:02.000Z",
  ...
  },
  {
    ...
    actor: MOCK_USERS[1],
    rendered_content: `<a data-user data-fw-bold href="/${MOCK_USERS[1].username}">${MOCK_USERS[1].name}</a> sent you a friend request. <a data-underline href="/me/content/relations?tab=friends">View all friend requests</a>`,
  ...
  },
  {
    ...
    actor: MOCK_USERS[3],
    rendered_content: `<a data-user data-fw-bold href="/${MOCK_USERS[3].username}">${MOCK_USERS[3].name}</a> published a new story "<a data-fw-medium href="/${MOCK_STORIES[2].user?.username}/${MOCK_STORIES[2].slug}">${MOCK_STORIES[2].title}</a>"`,
  ...
  },
  {
    ...
    type: NotificationType.STORY_LIKE,
    actor: MOCK_USERS[0],
    rendered_content: `<a data-user data-fw-bold href="/${MOCK_USERS[8].username}">${MOCK_USERS[8].name}</a> liked your story "<a data-fw-medium href="/${MOCK_STORIES[8].user?.username}/${MOCK_STORIES[8].slug}">${MOCK_STORIES[8].title}</a>"`,
    created_at: "2022-05-18T01:07:02.000Z",
  ...
  },
  {
    ...
    type: NotificationType.FRIEND_REQ_RECEIVED,
    actor: MOCK_USERS[1],
    rendered_content: `<a data-user data-fw-bold href="/${MOCK_USERS[6].username}">${MOCK_USERS[6].name}</a> sent you a friend request. <a data-underline href="/me/content/relations?tab=friends">View all friend requests</a>`,
    created_at: "2021-04-18T01:07:02.000Z",
  ...
  },
  {
    ...
    type: NotificationType.STORY_ADD_BY_USER,
    actor: MOCK_USERS[3],
    rendered_content: `<a data-user data-fw-bold href="/${MOCK_USERS[9].username}">${MOCK_USERS[9].name}</a> published a new story "<a data-fw-medium href="/${MOCK_STORIES[9].user?.username}/${MOCK_STORIES[9].slug}">${MOCK_STORIES[9].title}</a>"`,
    created_at: "2021-08-08T01:07:02.000Z",
