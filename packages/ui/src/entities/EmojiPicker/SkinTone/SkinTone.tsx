...
import { skinToneAtom } from "../core/atoms";
import { SkinTone as SkinToneEnum } from "../core/constants";
...
const SkinTone = (): React.ReactElement => {
  ...
  return (
    <Select
      onValueChange={(newValue): void => setValue(newValue as SkinToneEnum)}
      slotProps={{
        content: {
          sideOffset: 8,
          position: "popper",
