...
/**
 * Moves `num_characters` to the right in the current selection with `delay_ms` of delay between each keystroke
 * @param page Page
...
export const move_right = async (
  ...
  await press_key_times(page, "ArrowRight", num_characters, delay_ms);
