...
import { Binding, Provider } from "../bindings";
import { CollabDecoratorNode } from "../collab-decorator-node";
import { CollabElementNode } from "../collab-element-node";
import { CollabLineBreakNode } from "../collab-line-break-node";
import { CollabTextNode } from "../collab-text-node";
...
const createCursor = (name: string, color: string): Cursor => ({
  color: color,
  name: name,
  selection: null
});

const destroySelection = (binding: Binding, selection: CursorSelection) => {
...
const destroyCursor = (binding: Binding, cursor: Cursor) => {
