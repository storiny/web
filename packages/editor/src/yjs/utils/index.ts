...
import { Binding, YjsNode } from "../bindings";
import {
  $createCollabDecoratorNode,
  CollabDecoratorNode
} from "../collab-decorator-node";
import {
  $createCollabElementNode,
  CollabElementNode
} from "../collab-element-node";
import {
  $createCollabLineBreakNode,
  CollabLineBreakNode
} from "../collab-line-break-node";
import { $createCollabTextNode, CollabTextNode } from "../collab-text-node";
...
const getNodeTypeFromSharedType = (
