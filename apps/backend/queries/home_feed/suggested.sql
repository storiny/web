        ...
        INNER JOIN users u ON u.id = s.user_id
            ...
            AND (
              ...
              EXISTS (
                  SELECT 1
                  FROM friends
                  WHERE (transmitter_id = u.id AND receiver_id = $1)
...
-- Join followed tags for current user
    LEFT OUTER JOIN tag_followers AS "s->story_tags->follower" ON "s->story_tags->follower".tag_id = "s->story_tags".tag_id
