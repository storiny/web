...
DROP FUNCTION IF EXISTS reply_like_before_update_trigger_proc;

DROP TRIGGER IF EXISTS reply_like_delete_trigger ON reply_likes;

DROP FUNCTION IF EXISTS reply_like_delete_trigger_proc;
