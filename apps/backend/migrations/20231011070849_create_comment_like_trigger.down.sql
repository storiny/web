...
DROP FUNCTION IF EXISTS comment_like_before_update_trigger_proc;

DROP TRIGGER IF EXISTS comment_like_delete_trigger ON comment_likes;

DROP FUNCTION IF EXISTS comment_like_delete_trigger_proc;
