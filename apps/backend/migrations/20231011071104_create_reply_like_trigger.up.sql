-- Insert
--
CREATE OR REPLACE FUNCTION reply_like_insert_trigger_proc()
    RETURNS TRIGGER
    AS $$
BEGIN
...
CREATE OR REPLACE TRIGGER reply_like_insert_trigger
    AFTER INSERT ON reply_likes
    FOR EACH ROW
    EXECUTE PROCEDURE reply_like_insert_trigger_proc();
