...
import { VirtualizedBlogRequestList } from "~/common/blog-request";
...
import styles from "./blog-requests.module.scss";
...
const BlogRequests = (): React.ReactElement => {
