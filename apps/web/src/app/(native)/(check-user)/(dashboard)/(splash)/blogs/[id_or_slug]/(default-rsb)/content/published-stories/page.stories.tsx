...
import ContentPublishedStoriesPage from "./client";

const meta: Meta<typeof ContentPublishedStoriesPage> = {
  title: "blog-dashboard/content/published-stories",
  component: ContentPublishedStoriesPage,
  args: {
...
export default meta;
type Story = StoryObj<typeof ContentPublishedStoriesPage>;
