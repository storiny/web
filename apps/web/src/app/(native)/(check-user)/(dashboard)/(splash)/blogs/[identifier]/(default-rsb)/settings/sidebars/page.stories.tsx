...
import BlogSidebarsPage from "./client";

const meta: Meta<typeof BlogSidebarsPage> = {
  title: "blog-dashboard/settings/sidebars",
  component: BlogSidebarsPage,
  parameters: {
    layout: "fullscreen"
  },
  tags: ["autodocs"]
...
export default meta;
type Story = StoryObj<typeof BlogSidebarsPage>;
