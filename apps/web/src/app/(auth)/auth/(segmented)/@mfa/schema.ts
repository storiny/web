...
// The actual length of the recovery code is 12 characters, but we allow the users to enter the code with
// hyphens or whitespace in between. The code is sanitized before it is sent to the server.
