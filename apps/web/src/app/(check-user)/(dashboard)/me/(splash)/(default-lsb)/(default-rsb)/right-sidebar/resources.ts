export const RECOMMENDED_SUPPORT_RESOURCES = [
  ...
  { title: "How to write a story", href: "/support/writing-a-story" },
  { title: "How to update your e-mail", href: "/support/updating-email" },
  { title: "How to change font preferences", href: "/support/font-preferences" }
] as const;
